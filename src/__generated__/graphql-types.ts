...
export type GetPoolsQuery = { __typename?: 'Query', poolGetPools: Array<{ __typename: 'GqlPoolMinimal', address: any, chain: GqlChain, name: string, decimals: number, type: GqlPoolType, id: string, symbol: string, createTime: number, owner?: any | null, tags?: Array<string | null> | null, hook?: { __typename?: 'GqlHook', type: GqlHookType } | null, poolTokens: Array<{ __typename: 'GqlPoolTokenDetail', weight?: any | null, symbol: string, address: string, index: number }>, dynamicData: { __typename?: 'GqlPoolDynamicData', poolId: string, fees24h: any, swapFee: any, totalLiquidity: any, totalShares: any, volume24h: any, yieldCapture48h: any, aprItems: Array<{ __typename?: 'GqlPoolAprItem', apr: number, id: string, type: GqlPoolAprItemType, rewardTokenSymbol?: string | null }> } }> };

export type GetCurrentPricesQueryVariables = Exact<{
  chains: Array<GqlChain> | GqlChain;
}>;


export type GetCurrentPricesQuery = { __typename?: 'Query', tokenGetCurrentPrices: Array<{ __typename?: 'GqlTokenPrice', address: string, price: number }> };
...
export type GetHistoricalPricesQuery = { __typename?: 'Query', tokenGetHistoricalPrices: Array<{ __typename?: 'GqlHistoricalTokenPrice', address: string, chain: GqlChain, prices: Array<{ __typename?: 'GqlHistoricalTokenPriceEntry', price: number, timestamp: string }> }> };
...
export const GetPoolByIdDocument = gql`
    query GetPoolById($id: String!, $chain: GqlChain!) {
 ...
 * });
 */
export function useGetPoolByIdQuery(baseOptions: Apollo.QueryHookOptions<GetPoolByIdQuery, GetPoolByIdQueryVariables> & ({ variables: GetPoolByIdQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
...
export function useGetPoolByIdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetPoolByIdQuery, GetPoolByIdQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetPoolByIdQuery, GetPoolByIdQueryVariables>(GetPoolByIdDocument, options);
        }
...
export type GetPoolByIdSuspenseQueryHookResult = ReturnType<typeof useGetPoolByIdSuspenseQuery>;
...
export const GetPoolsDocument = gql`
    query GetPools($first: Int, $orderBy: GqlPoolOrderBy, $orderDirection: GqlPoolOrderDirection, $skip: Int, $textSearch: String, $where: GqlPoolFilter) {
  poolGetPools(
    first: $first
    orderBy: $orderBy
...
export const GetCurrentPricesDocument = gql`
    query GetCurrentPrices($chains: [GqlChain!]!) {
...
/**
 * __useGetCurrentPricesQuery__
 *
 * To run a query within a React component, call `useGetCurrentPricesQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetCurrentPricesQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 ...
 * });
 */
export function useGetCurrentPricesQuery(baseOptions: Apollo.QueryHookOptions<GetCurrentPricesQuery, GetCurrentPricesQueryVariables> & ({ variables: GetCurrentPricesQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetCurrentPricesQuery, GetCurrentPricesQueryVariables>(GetCurrentPricesDocument, options);
      }
export function useGetCurrentPricesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetCurrentPricesQuery, GetCurrentPricesQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetCurrentPricesQuery, GetCurrentPricesQueryVariables>(GetCurrentPricesDocument, options);
        }
export function useGetCurrentPricesSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetCurrentPricesQuery, GetCurrentPricesQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetCurrentPricesQuery, GetCurrentPricesQueryVariables>(GetCurrentPricesDocument, options);
        }
export type GetCurrentPricesQueryHookResult = ReturnType<typeof useGetCurrentPricesQuery>;
export type GetCurrentPricesLazyQueryHookResult = ReturnType<typeof useGetCurrentPricesLazyQuery>;
export type GetCurrentPricesSuspenseQueryHookResult = ReturnType<typeof useGetCurrentPricesSuspenseQuery>;
export type GetCurrentPricesQueryResult = Apollo.QueryResult<GetCurrentPricesQuery, GetCurrentPricesQueryVariables>;
export const GetHistoricalPricesDocument = gql`
    query GetHistoricalPrices($addresses: [String!]!, $chain: GqlChain!, $range: GqlTokenChartDataRange!) {
 ...
 * });
 */
export function useGetHistoricalPricesQuery(baseOptions: Apollo.QueryHookOptions<GetHistoricalPricesQuery, GetHistoricalPricesQueryVariables> & ({ variables: GetHistoricalPricesQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
...
export function useGetHistoricalPricesSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetHistoricalPricesQuery, GetHistoricalPricesQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetHistoricalPricesQuery, GetHistoricalPricesQueryVariables>(GetHistoricalPricesDocument, options);
        }
...
export type GetHistoricalPricesSuspenseQueryHookResult = ReturnType<typeof useGetHistoricalPricesSuspenseQuery>;
...
export const GetPoolEventsDocument = gql`
    query GetPoolEvents($first: Int, $skip: Int, $where: GqlPoolEventsFilter) {
 ...
 * });
 */
export function useGetPoolEventsQuery(baseOptions?: Apollo.QueryHookOptions<GetPoolEventsQuery, GetPoolEventsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetPoolEventsQuery, GetPoolEventsQueryVariables>(GetPoolEventsDocument, options);
      }
export function useGetPoolEventsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetPoolEventsQuery, GetPoolEventsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetPoolEventsQuery, GetPoolEventsQueryVariables>(GetPoolEventsDocument, options);
        }
export function useGetPoolEventsSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetPoolEventsQuery, GetPoolEventsQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetPoolEventsQuery, GetPoolEventsQueryVariables>(GetPoolEventsDocument, options);
        }
...
/**
 * __useGetPoolsSummaryQuery__
 *
 * To run a query within a React component, call `useGetPoolsSummaryQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetPoolsSummaryQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 ...
 * });
 */
export function useGetPoolsSummaryQuery(baseOptions?: Apollo.QueryHookOptions<GetPoolsSummaryQuery, GetPoolsSummaryQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetPoolsSummaryQuery, GetPoolsSummaryQueryVariables>(GetPoolsSummaryDocument, options);
      }
export function useGetPoolsSummaryLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetPoolsSummaryQuery, GetPoolsSummaryQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetPoolsSummaryQuery, GetPoolsSummaryQueryVariables>(GetPoolsSummaryDocument, options);
        }
export function useGetPoolsSummarySuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetPoolsSummaryQuery, GetPoolsSummaryQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetPoolsSummaryQuery, GetPoolsSummaryQueryVariables>(GetPoolsSummaryDocument, options);
        }
export type GetPoolsSummaryQueryHookResult = ReturnType<typeof useGetPoolsSummaryQuery>;
export type GetPoolsSummaryLazyQueryHookResult = ReturnType<typeof useGetPoolsSummaryLazyQuery>;
export type GetPoolsSummarySuspenseQueryHookResult = ReturnType<typeof useGetPoolsSummarySuspenseQuery>;
export type GetPoolsSummaryQueryResult = Apollo.QueryResult<GetPoolsSummaryQuery, GetPoolsSummaryQueryVariables>;