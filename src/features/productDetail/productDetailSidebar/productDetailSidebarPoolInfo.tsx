  ...
  return (
    <div className={styles['product-detail-info__container']}>
      ...
      <InfoRow label="Swap Fee Manager">
        <ValueText
          text={yesNo(product.swapManager)}
          title={yesNo(product.swapManager)}
        />
      </InfoRow>

      <InfoRow label="Pause Manager">
        <ValueText
          text={yesNo(product.pauseManager)}
          title={yesNo(product.pauseManager)}
        />
      </InfoRow>
      ...
      <InfoRow label="Creation Date">
        <ValueText
          text={product.createTime ?? '—'}
          title={product.createTime ?? ''}
        />
      </InfoRow>
    </div>
  );
