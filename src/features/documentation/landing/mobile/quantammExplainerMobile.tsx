    ...
    <div className={styles.explainerRoot}>
      <Row>
        ...
        <Col span={24} className={styles.explainerTitleBlock}>
          <Title level={3} className={styles.explainerTitleIntro}>
            INTRODUCING
          </Title>
          <Title level={3} className={styles.explainerTitleMain}>
        ...
        <Col span={24}>
          <div className={styles.explainerGaugeRow}>
            <div className={styles.indexGaugeWrap} id="indexGauge">
              <AgGauge
                options={{
                  type: 'linear-gauge',
            ...
            <div className={styles.quantammGaugeWrap} id="quantammGauge">
              <AgGauge
                options={{
                  type: 'linear-gauge',
