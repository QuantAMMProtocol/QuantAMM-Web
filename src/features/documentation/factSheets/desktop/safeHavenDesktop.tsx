...
export function SafeHavenFactSheetDesktop() {
      ...
      <Row>
        ...
        <Col span={22}>
          ...
          <p>
            ...
            statistics. Random 1038-day length windows were selected within the
            training price range and optimisation was performed via stochastic
            gradient descent for 6000 steps with batches of 6 windows per step.
          </p>
        </Col>
        <Col span={1}></Col>
      </Row>
